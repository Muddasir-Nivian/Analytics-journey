...
**What I built:**
Complete Sales Analysis Dashboard with sales data with 200 rows across six months sales data, Found the Top Performing Regions, Categories, Sales Rep, Customer Segment, Tracking Parameters Performance across six months such as Region, Categories, Customer Segment, Further here is the complete version:[Month 01 - Week 4 - Practice File and Mini Project](./Month-01-Excel/Month1_Week4_Practice(AutoRecovered).xlsx)
...
Every Insight isn't important to show on dashboard only things that really matters to business should be on visualizer.
